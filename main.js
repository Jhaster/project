...
car2_width = 120;
car2_height = 70;
car2_image = "https://postimg.cc/tnnW1Kff";
car2_x = 10;
car2_y = 10;
...
function my_keydown(e)
{
	...
	console.log(keyPressed);
        ...
        if(car1_x > 700) { console.log("car1");
        document.getElementById('game_status').innerHTML = "Car 1 Won!!"; } else if(car2_x > 700) { console.log("car2");
